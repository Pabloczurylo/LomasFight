                    ...
                    <div className="relative w-full flex items-center justify-center">
                        ...
                        <div className="w-full flex justify-center gap-6 lg:gap-8 flex-col lg:flex-row px-12 sm:px-16 md:px-24 items-center">
                            {visibleProfesores.map((profesor) => (
                                <div key={profesor.id_profesor} className="bg-[#111115] border border-white/5 rounded-2xl p-8 lg:p-10 w-full sm:max-w-[380px] shadow-2xl flex flex-col items-center relative overflow-hidden group">
                                    {/* Top subtle glow */}
