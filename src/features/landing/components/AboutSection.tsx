            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="w-full md:w-1/2 flex justify-center">
                        <div className="bg-[#111115] border border-white/5 rounded-2xl p-8 max-w-sm w-full shadow-2xl flex flex-col items-center relative overflow-hidden group">
                            {/* Top subtle glow */}
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-32 bg-brand-red/10 blur-3xl rounded-full" />

                            {/* Profile Image */}
                            <div className="relative mb-6 mt-2">
                                <div className="w-40 h-40 rounded-full p-1 bg-gradient-to-b from-brand-red via-brand-red/50 to-transparent">
                                ...
                                {/* Verified Badge */}
                                <div className="absolute bottom-1 right-2 w-7 h-7 bg-[#111115] rounded-full flex items-center justify-center">
                            ...
                            {/* Info */}
                            <h3 className="text-xl font-black text-white uppercase tracking-wide mb-1 text-center">
                                VICTOR 'THE TITAN' LOMAS
                            </h3>
                            <p className="text-brand-red font-bold text-[10px] tracking-[0.1em] uppercase mb-4">
                                HEAD STRIKING COACH
                            </p>

                            <div className="w-8 h-[2px] bg-brand-red/70 mb-5 relative">
                                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[6px] bg-brand-red/20 blur-[2px]" />
                            </div>

                            <p className="text-gray-400 text-xs text-center leading-relaxed mb-8 px-2">
                            ...
                            <div className="flex flex-wrap justify-center gap-2 mb-8">
                                {['KICKBOXING', 'BOXING', 'MUAY THAI'].map(tag => (
                                    <span key={tag} className="px-3 py-1.5 rounded-full bg-brand-red/10 border border-brand-red/20 text-brand-red text-[9px] font-bold tracking-wider">
                                        {tag}
                                    </span>
                                ))}
                            </div>

                            <div className="flex items-center gap-1.5 text-[#3f3f46] uppercase text-[9px] font-bold tracking-[0.2em] relative z-10">
                                LOMAS FIGHT CLUB
